...
<template>
    <div class="about">
        <!-- <div class="dividing-bar" :style="{ transform: `translateY(${0 - (scroll - 0) / 5}px)` }"></div> -->
        ...
        <div class="full-slide first">
            ...
            <div class="text">
                ...
                <p>
                    ...
                    Check out
                    <a href="https://wyattcowley.com/music/" className="link" target="_blank" rel="noopener"> my portfolio here </a>
                    !<br />
                    <br />
